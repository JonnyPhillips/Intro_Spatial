...
include_graphics("Compact_Year.png")
```
...
```{r, out.width="900px", out.height="", fig.cap="", fig.align="center"}
include_graphics("rdd_map_trust_civil_service-1-1.png")
```
...
4. Spatial operations allow you to create new variables and measures
5. Spatial autocorrelation as a threat vs. an opportunity
6. Scale affects our results (eg. MAUP), so try and analyze at lets of scales
7. Maps mislead; understand your data!
