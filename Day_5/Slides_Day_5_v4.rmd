...
- Easier when politicians control the redistricting process
    ...
    - When voters are clustered: They pack and crack themselves, eg. black voters in the USA
...
include_graphics("rddmap_trust_civil_service-1-1.png")
```
...
$$y_i = \alpha + \beta Border_i + \gamma \text{Distance to Border}_i + \epsilon_i$$
