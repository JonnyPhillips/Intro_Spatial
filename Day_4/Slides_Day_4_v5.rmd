...
```{r, out.width="500px", fig.cap="Local Spatial Dissimilarity Index", fig.align="center"}
...
```{r, out.width="500px", fig.cap="Exposure of White to Coloured Population (https://complexsystemstheory.net/complexity-of-segregation/)", fig.align="center"}
...
- Segregation is complicated
    ...
    - We need lots of different measures of segregation
