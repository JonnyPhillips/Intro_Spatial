...
- Moran's I:
    - We can statistically test whether our value of Moran's I is higher or lower than we would expect if the characteristics was randomly distributed
...
- Local Indicators of Spatial Autocorrelation (LISA)
    ...
    - A 'High' unit in a 'Low' cluster
    - A 'Low' unit in a 'High' cluster
...
```{r, out.width="700px", fig.cap="Romao et al 2017", fig.align="center"}
...
[NYC Segregation, NY Times](https://www.nytimes.com/interactive/2015/07/08/us/census-race-map.html)
