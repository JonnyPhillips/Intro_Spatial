...
1. [Qgis] Join the Brazilian municipalities shapefile with the inequality (Theil) data
2. [GeoDa+R] Compare one contiguity-based and one distance-based spatial weights matrix for Brazilian municipalities.
...
5. [R] How racially segregated is Ceará state based on the census data?

Files:
[Brazilian Municipalities Shapefile]()  
[Inequality Data for Brazilian Municipalities]()  
